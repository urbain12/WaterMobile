...
import { addToCart, decreaseQty } from '../redux/shopping/shopping-catridge';
import { MaterialIcons, AntDesign, EvilIcons, FontAwesome, Ionicons, Feather, Entypo } from "@expo/vector-icons";


const CatridgesDetails = ({ navigation, currentItem, addToCart, cart, decreaseQty }) => {
    ...
    return (
        <View style={{ backgroundColor: "#fff", height: '100%',  }}>
                <View style={{
                    ...
                    <View style={{ width: "10%" }}>
                        <TouchableOpacity onPress={() => { navigation.navigate('Catridgecart') }}>
                            <FontAwesome
                                name="shopping-cart"
                                size={24}
                                color="#000" />
            ...
            <ScrollView>
                ...
                <Text style={{
                    ...
                    marginHorizontal: 20,
                    textAlign: "justify"
                }}>{currentItem.ToolID.Description}</Text>
            </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(CatridgesDetails);